...
import { Film, getAllFilms } from "../../api/films"
import "./style.scss"
                    ...
                    films.isSuccess 
                        ?
                            ...
                            films.data.data.films.map((film: Film) => (
                                <FilmCard coverImageUrl={film.img} genre={film.genres[0]} year={film.releaseDate} title={film.name} rating={film.userRatings.kinopoisk} key={film.id}/>
                            ))
